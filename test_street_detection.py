...
class TestStreetDetection(unittest.TestCase):
    ...
    def test_street_detection_in_custom_hand(self):
        ...
        hand_data = {
            ...
            "actions": [
                ...
                {"player_name": "Player2", "action_type": "bet", "amount": 5.0, "street": "flop"},
                {"player_name": "Player3", "action_type": "call", "street": "flop"},
                {"player_name": "Player2", "action_type": "bet", "amount": 10.0, "street": "turn"},
        ...
        with self.app.app_context():
            ...
            # Check street information
            expected_streets = ['preflop', 'preflop', 'preflop', 'flop', 'flop', 'turn', 'turn']
            actual_streets = [action.street for action in actions]
    ...
    def test_street_defaults_to_preflop(self):
        ...
        hand_data = {
            ...
            "actions": [
                {"player_name": "Player1", "action_type": "fold"},  # No street specified
                {"player_name": "Player2", "action_type": "check"}  # No street specified
            ],
            "small_blind": 1.0,
            "big_blind": 2.0
        }
    ...
    def test_mixed_street_scenarios(self):
        ...
        hand_data = {
            ...
            "actions": [
                ...
                {"player_name": "Player1", "action_type": "bet", "amount": 5.0, "street": "flop"},
                {"player_name": "Player2", "action_type": "raise", "amount": 15.0, "street": "flop"},
                {"player_name": "Player1", "action_type": "call", "street": "flop"},
                {"player_name": "Player1", "action_type": "check", "street": "turn"},
                {"player_name": "Player2", "action_type": "bet", "amount": 20.0, "street": "turn"},
        ...
        with self.app.app_context():
            ...
            expected_streets = ['preflop', 'preflop', 'flop', 'flop', 'flop', 'turn', 'turn', 'turn', 'river', 'river']
            actual_streets = [action.street for action in actions]
